...
class MahasiswaAdapter(val mahasiswaList: ArrayList<Mahasiswa>): RecyclerView.Adapter<MahasiswaAdapter.ViewHolder>(){
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            val user: Mahasiswa = mahasiswaList[position]
